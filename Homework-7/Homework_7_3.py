...
# экземпляр класса и количество ячеек в ряду.
...
class Cell:
    ...
    def make_order(self, t):
        cc = '*' * self.y
        print('\n'.join(cc[i:i + t] for i in range(0, len(cc), t)))


c_1 = Cell(33)
c_2 = Cell(15)
print(c_1.y - c_2.y if c_1.y - c_2.y > 0 else 'не корректное значение')
